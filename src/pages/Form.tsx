...
//           method: "PUT",
//           key: `uploads/tmp/${crypto.randomUUID()}-${file.name}`,
...
//               onChange={(v: string) => update("phone_number", v)}
//             />
...
//                   onChange={(v: string) => update("company_url", v)}
//                 />
//                 <FieldCard
//                   label="Company LinkedIn"
//                   icon={<Linkedin size={18} />}
//                   value={form.company_linkedin}
//                   onChange={(v: string) => update("company_linkedin", v)}
//                 />
//               </div>
...
//                   onChange={(v: string) => update("location_city", v)}
//                 />
//                 <FieldCard
//                   label="State / Region"
//                   icon={<MapPin size={18} />}
//                   value={form.location_region}
//                   onChange={(v: string) => update("location_region", v)}
//                 />
//                 <FieldCard
//                   label="Country"
//                   icon={<MapPin size={18} />}
//                   value={form.location_country}
//                   onChange={(v: string) => update("location_country", v)}
//                 />
//               </div>
//             </div>
